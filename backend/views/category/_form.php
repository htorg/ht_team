...
<div class="category-form">
	...
	<?= $form->field($model, 'type')->dropDownList(CmsCategory::getCategoryType(),['prompt'=>Yii::t('app', 'Please select'),'style'=>'width:20%;'])->hint(Yii::t('app', 'This item\'s parent node.')) ?>
    ...
    ])->hint(Yii::t('app', 'File type: ').'jpg\png,'.Yii::t('app', 'File max size: ').' 2MB')->label(Yii::t('app', 'Banner File'));?>
    ...
    <?= $form->field($model, 'image_main_file')->widget(FileInput::classname(), ['options' => ['accept' => 'image/jpg,image/jpeg,image/png'],
        'pluginOptions' => $pluginOptions
    ])->hint(Yii::t('app', 'File type: ').'jpg\png,'.Yii::t('app', 'File max size: ').' 2MB')->label(Yii::t('app', 'Image Main File'));?>
    ...
    <?= $form->field($model, 'image_node_file')->widget(FileInput::classname(), ['options' => ['accept' => 'image/jpg,image/jpeg,image/png'],
        'pluginOptions' => $pluginOptions
    ])->hint(Yii::t('app', 'File type: ').'jpg\png,'.Yii::t('app', 'File max size: ').' 2MB')->label(Yii::t('app', 'Image Node File'));?>
