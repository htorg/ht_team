...
<div class="row">
	<div class="col-md-12">
		<div class="box style_box1">
            ...
            <div class="box-body ">
            	<p>
                    <?= Html::a(Yii::t('app', 'Create Cms Banner'), ['create'], ['class' => 'btn btn-primary']) ?>
                </p>
                    ...
                    [
                            ...
                            'buttons'=>[
                                'pic' => function ($url, $model, $key) {
                                    return Html::button(Yii::t('app', 'Pic'), ['class'=>'btn btn-primary','onclick'=>'window.location.href="'.Url::toRoute(['cms-banner-pic/index','CmsBannerPicSearch[banner_id]'=>$model->id]).'";']);
                                },
                                'user-update' => function ($url, $model, $key) {
                                    if ($model->necessary == 1)
                                        return '';
                                    return Html::button(Yii::t('yii', 'Update'), ['class'=>'btn btn-primary','onclick'=>'window.location.href="'.Url::toRoute(['banner/update','id'=>$model->id]).'";']);
                                },
