...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a class="bg_color logo" href="<?php echo Url::toRoute(['site/index'])?>" >
        ...
        <!-- Header Navbar -->
        <nav class="navbar navbar-static-top bg_color" role="navigation">
...
<!--                     </li> -->
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="<?php echo \common\helpers\SiteHelper::getUserAvatar('');?>" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="<?php echo \common\helpers\SiteHelper::getUserAvatar('');?>" class="img-circle" alt="User Image">
    ...
    <aside class="main-sidebar bg_color">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info ft_color">
                    <p><?php echo Yii::t('app', 'Welcome')?></p>
                    <!-- Status -->
                    <a class="ft_color" href="javascript:;"><?php echo Yii::$app->user->identity->username?></a>
                </div>
            </div>
