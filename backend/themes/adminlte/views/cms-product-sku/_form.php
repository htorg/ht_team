...
<div class="cms-product-sku-form">
    ...
    <?= $form->field($model, 'value')->textarea(['maxlength' => true, 'style'=>'width:50%;'])->hint(Yii::t('app', 'Required'))->label('描述'); ?>
    
    <?= $form->field($model, 'info')->textarea(['maxlength' => true, 'style'=>'width:50%;'])->hint(Yii::t('app', 'Required'))->label('子节点，用#分开'); ?>
