...
<div class="row">
    <div class="col-md-12">
    	<div class="box style_box1">
                ...
                <div class="box-body ">
                	<p>
                        <?= Html::a(Yii::t('app', 'Create Theme Category'), ['create'], ['class' => 'btn btn-primary']) ?>
                    </p>
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'user-update' => function ($url, $model, $key) {
                                        return Html::button(Yii::t('yii', 'Update'), ['class'=>'btn btn-primary','onclick'=>'window.location.href="'.Url::toRoute(['gh-theme-category/update','id'=>$model->id]).'";']);
                                    },
