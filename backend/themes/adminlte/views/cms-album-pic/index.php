    ...
    <div class="col-md-12">
    	<div class="box style_box1">
                <div class="box-header with-border">
                  <h3 class="box-title" style="margin-right:20px;margin-bottom:5px;"><?php echo Yii::t('app', 'Cms Album').'：'.$album->name.'('.$album->count_pic.')';?></h3>
                    <button class="btn btn-primary" onclick="clickGoBack()">返回</button>
                </div>
                <div class="box-body ">
