	...
	<div class="col-md-12">
		<div class="box style_box1">
            ...
            <ul class="turnBtn_list clearfix">
                <li class="turnBtn_li"><a href="<?php echo Url::toRoute(['case-category/index'])?>" class="btn turnBtn_item turnBtn_item_on"><i class="turnBtn_ico">1.</i>产品案例列表</a></li>
				<li class="turnBtn_li"><a href="<?php echo Url::toRoute(['case/index'])?>" class="btn turnBtn_item "><i class="turnBtn_ico">2.</i>产品案例信息</a></li>
            </ul>
        </div>
            <div class="box-body ">
            	<p>
            		<?php $btn_options = ['class' => 'btn btn-danger  create-btn','style' => 'vertical-align:top','onclick'=>'window.location.href="'.Url::toRoute(['case-category/create']).'";']; ?>
