...
<div class="row">
    <div class="col-md-12">
    	<div class="box style_box1">
                ...
                <div class="box-body ">
                	<p>
                        <?= Html::a(Yii::t('app', 'Create Cms Banner Pics'), ['create','banner_id'=>$searchModel->banner_id], ['class' => 'btn btn-primary']) ?>
                        <?= Html::a(Yii::t('app', 'Back to banner list'), ['banner/index'], ['class' => 'btn btn-primary']) ?>
                    </p>
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'user-update' => function ($url, $model, $key) {
                                      return Html::button(Yii::t('yii', 'Update'), ['class'=>'btn btn-primary','onclick'=>'window.location.href="'.Url::toRoute(['cms-banner-pic/update','id'=>$model->id]).'";']);
                                    },
