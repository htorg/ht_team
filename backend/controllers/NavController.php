...
class NavController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['index', 'save', 'save-link', 'delete-link','manager','manager-page','new'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionIndex()
    {
        ...
        if (empty($navsHtml))
        {
            $navsHtml = NavHelper::getNavsHtmlHt($navs, $navTypeNames);
    ...
    public function actionManager(){
        ...
        $lang_id = \Yii::$app->params['lang_id'];
        $navs = NavHelper::getCacheNavs($site_id, $lang_id);
        return $this->render('manager',['navs'=>$navs]);
    }
    public function actionManagerPage(){
    	...
    	return $this->render('manager-page',['navs'=>$features]);
    }
