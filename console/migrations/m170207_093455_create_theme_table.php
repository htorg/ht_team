...
class m170207_093455_create_theme_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('gh_theme', ['category_id','name','code','desc','features','image_pc','necessary','status','created_at','updated_at'], [
            [1,'默认模板1','t00008','默认模板1','1001,2001,3001,4001,4002,4003,5001,6001,7001,8001,9001','/uploads/default/theme_first_cover.png',1,10,$now,$now],
        ]);
    }
