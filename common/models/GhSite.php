...
class GhSite extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'host_name','id','serial_id'], 'required'],
            [['user_id', 'type', 'plan_id', 'plan_created_at', 'plan_expired_at', 'status', 'created_at', 'updated_at','id'], 'integer'],
            [['host_name','serial_id'], 'string', 'max' => 255],
            [['host_name'], 'unique'],
