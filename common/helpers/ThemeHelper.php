...
class ThemeHelper {
     ...
     * 后台根据此变量的值来生成侧边栏
     */
	static public $THEME_FEATURE_HOMECONFIG         =1000;
    ...
    static public $THEME_FEATURE_UPLOADFILE       	= 10003;
    static public $THEME_FEATURE_JOININFO       	= 10004;
    ...
    static public function getFeatureNames($feature='')
    {
    	if(!$feature){
    		return [
    				self::$THEME_FEATURE_HOMECONFIG=>\Yii::t('app', 'Cms Index Configs'),
    				...
    				self::$THEME_FEATURE_UPLOADFILE=\Yii::t('app','Upload File'),
    				self::$THEME_FEATURE_JOININFO=\Yii::t('app', 'Join Info'),
    ...
    static public function setThemeByCode($code) {
        ...
        Yii::$app->view->theme = new \yii\base\Theme([
            ...
            'pathMap' => [
            		'@app/views' => '@app/themes/'. $code . '/views',
            		'@app/widgets' => '@app/themes/'. $code . '/widgets',
            ], //指定视图文件的替换规则。 更多细节将在下面介绍
    ...
    static public function getFeatureId($rel)
    {
        ...
        switch ($rel)
        {
            ...
            case 'friendlink':
                ...
                break;
            case 'cms-uploadfile':
                $feature = self::$THEME_FEATURE_UPLOADFILE;
                break;
            case 'cms-join-info':
            	$feature=self::$THEME_FEATURE_JOININFO;
        }
    ...
    static public function getFeaturesAll($type='features'){
    	$theme_arr = backend\helpers\SiteHelper::getThemeArr();
    	$features = explode(',', $theme_arr[$type]);
    	if (!is_array($features))
    	{
    	...
    	foreach ($features as $feature){
    		$featuresAll[$feature]=self::getFeatureNames($feature);
    	}
    	return $featuresAll;
    }
    ...
    static public function getManagerUrl($type){
    	switch ($type){
    		case ThemeHelper::$THEME_FEATURE_ALBUM:
    			return Url::toRoute(['cms-album/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_ARTICLE:
    			return Url::toRoute(['article/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_BANNER:
    			return Url::toRoute(['banner/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_CASE:
    			return Url::toRoute(['case-category/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_CATEGORY:
    			return Url::toRoute(['category/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_FRIENDLINK:
    			return Url::toRoute(['friend-link/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_NAV:
    			return Url::toRoute(['cms-index-config/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_PAGE:
    			return Url::toRoute(['page/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_PAGE_ABOUT:
    			return Url::toRoute(['page-about/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_PAGE_CONTACT:
    			return Url::toRoute(['page-contact/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_PRODUCT:
    			return Url::toRoute(['cms-product-config/update']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_SERVICE:
    			return Url::toRoute(['cms-service/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_UPLOADFILE:
    			return Url::toRoute(['cms-upload/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_JOININFO:
    			return Url::toRoute(['cms-join-info/index']);
    			break;
    		case ThemeHelper::$THEME_FEATURE_HOMECONFIG:
    			return Url::toRoute(['cms-index-config/index']);
    			break;
